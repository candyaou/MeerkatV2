        ...
        update: function(groupId, groupName, groupDetails) {
            return new Promise(function(resolve, reject) {
                if (groupDetails != undefined) {
                    resolve(_client.face.personGroup.update(groupId, groupName, groupDetails))
                } else {
                    resolve(_client.face.personGroup.update(groupId, groupName))
                }
        ...
        update: function(groupId, personId, personName, personDetail) {
            return new Promise(function(resolve, reject) {
                if (personDetail != undefined) {
                    resolve(_client.face.person.update(groupId, personId, personName, personDetail))
                } else {
                    resolve(_client.face.person.update(groupId, personId, personName))
                }
                
                reject({error: "Failed to update member in the group"})
            })
        },
